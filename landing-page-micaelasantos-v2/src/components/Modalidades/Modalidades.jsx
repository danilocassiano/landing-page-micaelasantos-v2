...
export default function Modalidades() {
    ...
    return (
        <div className={styles['modalidades-container']}>
            <h2 data-aos="fade-right" data-aos-duration="1000" data-aos-delay="50" className={styles.title1}>Modalidades de Atendimento:</h2>
            <br/>
            <br/>
